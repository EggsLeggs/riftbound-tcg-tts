json1=[[
{
  ...
  "Nickname": "Goat\nToken Creature — Goat 0CMC",
  "Description": "\n[b]0/1[/b]",
  "GMNotes": "",
  "Memo": "f62b776a-d4de-455a-ae5a-ca07982974db",
  "ColorDiffuse": {
    "r": 0.713235259,
    "g": 0.713235259,
    "b": 0.713235259
  ...
  "CustomDeck": {
    "98": {
      "FaceURL": "https://c1.scryfall.com/file/scryfall-cards/large/front/2/1/213be25c-88db-440b-83c3-973586a4f320.jpg",
...
json2=[[
{
  ...
  "CustomDeck": {
    "182": {
      "FaceURL": "https://c1.scryfall.com/file/scryfall-cards/large/front/7/2/720f3e68-84c0-462e-a0d1-90236ccc494a.jpg",
      "BackURL": "https://steamusercontent-a.akamaihd.net/ugc/1646591393626667202/25E9E2A96F478D59E8961BBE161CC0D29908C5A6/",
      "NumWidth": 1,
      "NumHeight": 1,
      "BackIsHidden": true,
...
function onLoad()
  noencode=true
  self.createButton({
    click_function='getToken1',
    function_owner=self,
    label='spawn goat',
    position={0,0.28,-0.75},
    scale={0.5,0.5,0.5},
    width=1400,
    height=300,
    font_size=200,
